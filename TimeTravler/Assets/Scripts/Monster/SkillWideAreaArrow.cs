...
public class SkillWideAreaArrow : MonoBehaviour
{
    ...
    private void EndSkillWideAreaStart()
    {
        ...
        SkillWideArea.GetComponent<Animator>().runtimeAnimatorController = Resources.Load("Monster/AnimationControllers/" + Convert.ToString(monsterNum) + "/" + Convert.ToString(monsterNum) + "WideArea0") as RuntimeAnimatorController;
        Destroy(gameObject);
    }
}
